...
const styleContentOverrides: Record<string, StyleContentOverride> = {
  ...
  "retro-futurism": {
    summary: "레트로 퓨처리즘은 과거가 상상한 미래를 둥근 우주선 패널, 빈티지 기술 색, 낙관적인 여행 UI로 재구성하는 스타일입니다.",
    description:
      "레트로 퓨처리즘은 미래적이지만 차갑지 않고, 과거의 우주 시대 낙관주의가 보여야 합니다. Retro Futurism, Paleofuture, Web Design Museum 같은 아카이브를 바탕으로 우주 여행 예약, 궤도 지도, 둥근 계기판, 크림/코랄/터쿼이즈 조합을 실제 랜딩 화면으로 구성합니다.",
    visualFeatures: ["둥근 계기판과 티켓형 카드가 과거의 미래감을 만듭니다.", "코랄, 터쿼이즈, 크림, 네이비가 우주 시대 팔레트를 구성합니다.", "로켓, 궤도, 시간표 같은 정보 모듈이 실제 서비스처럼 보입니다."],
    colorPalette: ["짙은 네이비를 우주 배경처럼 사용합니다.", "크림과 골드를 따뜻한 미래 표면으로 둡니다.", "코랄과 터쿼이즈를 행동/경로 포인트로 씁니다."],
    typography: ["모노스페이스나 기계식 라벨이 잘 어울립니다.", "제목은 굵지만 둥근 미래 낙관주의가 느껴져야 합니다.", "수치, 출발 시간, 궤도 라벨을 작은 정보 단위로 둡니다."],
    layoutTraits: ["우주 여행 예약, 비행 콘솔, 제품 티저, 전시 랜딩에 어울립니다.", "둥근 패널과 표 형태의 일정 정보가 함께 보여야 합니다.", "모바일에서는 티켓, 경로, CTA 순서로 명확히 구성합니다."],
    ...
    cautions: ["Cyberpunk처럼 어둡고 디스토피아적으로 가면 방향이 달라집니다.", "일반 Retro보다 우주/기술/시간표 모듈이 보여야 합니다.", "장식적 행성만 있으면 실제 웹 화면처럼 보이지 않습니다."],
    imagePrompt:
      "A retro futurism space travel website reference image with navy background, rounded spacecraft control panels, cream ticket cards, coral turquoise accents, orbit schedule modules, no logo, no watermark",
    research: {
      referenceSites: [
      ...
      representativeTraits: ["Space-age optimism", "Rounded control panels", "Orbit schedule cards", "Warm future palette", "Travel-console CTA"],
      avoidTraits: ["Cyberpunk dystopia", "Generic retro badges", "Y2K plastic gloss"],
      tokenIntent:
        "Use navy space backgrounds, rounded panels, mono labels, warm cream ticket cards, coral and turquoise accents, and schedule modules so the style reads as retro futurism.",
    },
  },
};
...
const styleTokenOverrides: Record<string, DeepPartial<Omit<StyleTokens, "color">>> = {
  ...
  "retro-futurism": {
    typography: { displayFont: '"SFMono-Regular", monospace', bodyFont: '"SFMono-Regular", monospace', weightDisplay: 800, weightBody: 500, tracking: "0em", headingScale: 1.02 },
    shape: { radius: "18px", radiusPill: "9999px", borderWidth: "2px", borderStyle: "solid" },
